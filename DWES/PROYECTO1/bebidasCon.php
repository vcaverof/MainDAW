...
$sql = "SELECT id_producto, nombre, descripcion, precio, stock FROM productos WHERE id_categoria = 1";
...
<?php if (count($productos) > 0): ?>
    <form method="POST" action="añadir_carrito.php">
        ...
        <input type="hidden" name="origen" value="bebidasCon.php"> <!-- cambia según la página -->
    </form>
<?php else: ?>
