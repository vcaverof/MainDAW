...
// Obtener productos de categoría "sin alcohol"
$sql = "SELECT id_producto, nombre, descripcion, precio, stock FROM productos WHERE id_categoria = 2";
...
<?php if (count($productos) > 0): ?>
    <form method="POST" action="añadir_carrito.php">
        ...
        <input type="hidden" name="origen" value="bebidasSin.php">
    </form>
<?php else: ?>
