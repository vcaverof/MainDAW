...
<body>
    <div class="formulario">
        ...
        <form action="enc.php" method="post">
            <label>Numero: </label>
            <input type="text" name="numero" max="99" min="1" placeholder="1 - 99" required>

            <label>Cadena de texto: </label>
            <input type="text" name="texto" max="10" placeholder="Máximo 10 caracteres" required>

            <div class="enc-group">
                <div class="enc-option">
                    <label for="encriptar">Encriptar</label>
                    <input type="radio" name="enc" value="encriptar" id="encriptar" checked>
                </div>
                <div class="enc-option">
                    <label for="desencriptar">Desencriptar</label>
                    <input type="radio" name="enc" value="desencriptar" id="desencriptar">
                </div>
            </div>
